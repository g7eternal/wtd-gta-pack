#define MyAppName "What The Dub: Grand Theft Auto pack"
#define MyAppVersion "1.0"
#define MyAppPublisher "@G7_Eternal"
#define MyAppURL "https://github.com/g7eternal/wtd-gta-pack"
#define MyAppSourceURL "https://github.com/g7eternal/wtd-gta-pack/archive/refs/heads/main.zip"
;#define MyAppSourceURL "http://localhost:2234/wtd-gta-pack-main.zip"
...
AppId={{43066F75-F25C-44BD-95E5-D5740A2BE1DB}
AppName={#MyAppName}
...
OutputDir=target
OutputBaseFilename=wtd-gta-pack-auto
...
ExtraDiskSpaceRequired=987654321

[Types]
Name: "full"; Description: "Full installation"
Name: "sfx"; Description: "Only custom sounds"
Name: "custom"; Description: "Custom installation"; Flags: iscustom

[Components]
Name: Gta_clips_pack; Description: "New custom clips"; Types: full custom
Name: Gta_sounds_pack; Description: "New custom sound effects"; Types: full sfx custom

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Tasks]
Name: pack_exclusive; Description: "Use new clips EXCLUSIVELY: all existing clips will be removed from the game, you will be playing only with clips from this pack"; GroupDescription: "Select installation variant:"; Components: Gta_clips_pack; Flags: exclusive
Name: pack_mixed; Description: "MIX UP all the clips: new clips will be added into the clip pool"; GroupDescription: "Select installation variant:"; Components: Gta_clips_pack; Flags: exclusive unchecked

[Files]
Source: "{tmp}\VideoClips\*"; DestDir: "{code:GetInstallPath|}StreamingAssets\VideoClips"; Components: Gta_clips_pack; Flags: ignoreversion recursesubdirs createallsubdirs external
Source: "{tmp}\Subtitles\*"; DestDir: "{code:GetInstallPath|}StreamingAssets\Subtitles"; Components: Gta_clips_pack; Flags: ignoreversion recursesubdirs createallsubdirs external
Source: "{tmp}\CustomSfx\*"; DestDir: "{code:GetInstallPath|}StreamingAssets\CustomSfx"; Components: Gta_sounds_pack; Flags: ignoreversion recursesubdirs createallsubdirs external
...
const Steam32RegPath = 'SOFTWARE\Valve\Steam';
      ...
      WTD_ZipContainer= 'wtd-gta-pack-main.zip';
...
begin
  ...
  ChooseGamePage.Add('RiffTrax: The Game');
  ...
  'We have attempted to find selected game on your PC.'#13#10'The custom pack will be installed into this folder.'#13#10#13#10 +
  ...
  Case CurStep of
    ssInstall: begin
      ...
      try
        ...
        if WizardIsComponentSelected('Gta_clips_pack') and not(WizardIsTaskSelected('pack_mixed')) then
    ...
    ssPostInstall: begin
      ...
      MsgBox('WTD: GTA pack has been installed!'#13#10#13#10
        'Should you ever want to remove the pack, you are better off re-installing the game. (yep, still no uninstaller in current year)'#13#10
